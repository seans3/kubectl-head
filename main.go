...
`,
	...
	cmd.Flags().Int64Var(&o.limit, "limit", DefaultHeadLimit, "Number of items to return per page.")
...
func (o *HeadOptions) Complete() error {
	var err error
...
// main is the entrypoint for the kubectl-head plugin.
func main() {
	streams := genericclioptions.IOStreams{In: os.Stdin, Out: os.Stdout, ErrOut: os.Stderr}
	cmd := NewCmdHead(streams)

	// To make this a valid kubectl plugin, the binary must be named "kubectl-head".
